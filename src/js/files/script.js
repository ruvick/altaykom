...
const catEntityTableTr = document.querySelector('.catalog-entity-table__name');
...
// 	if (!target.closest('.catalog-entity-table__name')) { // если этот элемент или его родительские элементы не окно навигации и не кнопка
